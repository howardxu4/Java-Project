 ...
 *
 * SwToggleButton is a class of JToggleButton which configured by XML 
 *
 * </pre>
 *******************************************************************************
 * <B> Author: </B><p><pre>
...
public class SwToggleButton extends JToggleButton implements Iforward
{
	public SwToggleButton(readXML rd, Node pnode) {
		super();
