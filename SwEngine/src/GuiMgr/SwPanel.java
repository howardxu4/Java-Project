 ...
 *
 * SwPanel is a class of JPanel which configured by XML 
 *
 * </pre>
 *******************************************************************************
 * <B> Author: </B><p><pre>
 ...
 *******************************************************************************
*/
public class SwPanel extends JPanel implements Iforward
{
	public SwPanel(readXML rd, Node pnode) {
		super();
		new SwEngine(this, rd, pnode, true);
	}
