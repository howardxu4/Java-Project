 ...
 *******************************************************************************
*/
public class Argument extends Hashtable <String, Object>
{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 8445684063355133859L;
	 ...
	 */	
    public Enumeration <String> getArgumentNames()
    {
 		return this.keys();
    }
